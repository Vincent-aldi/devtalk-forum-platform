...
Aplikasi forum diskusi yang dibangun dengan menggunakan arsitektur microservices modern. Proyek ini mendemonstrasikan komunikasi antar-layanan menggunakan HTTP (Synchronous) dan RabbitMQ (Asynchronous/Event-Driven).
